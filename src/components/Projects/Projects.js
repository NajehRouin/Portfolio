      ...
      <Container>
        ...
        <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="App E-commerce shopping using reactJs redux expressJs nodeJs mongoDB tailwindCss and to store the image I used Cloudinary. "
              git="https://github.com/NajehRouin/E-Commerce-MERN-APP"
